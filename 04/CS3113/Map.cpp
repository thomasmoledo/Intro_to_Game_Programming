...
void Map::build()
{
    ...
    mLeftBoundary   = mOrigin.x - (mMapColumns * mTileSize) / 2.0f - mTileSize / 2.0f;
    mRightBoundary  = mLeftBoundary + (mMapColumns * mTileSize);
    mTopBoundary    = mOrigin.y - (mMapRows * mTileSize) / 2.0f - mTileSize / 2.0f;
    mBottomBoundary = mTopBoundary + (mMapRows * mTileSize);
